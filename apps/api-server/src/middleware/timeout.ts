...
export const LONG_RUNNING_NOTE_PATH =
  /^\/api\/v1\/notes\/(transcribe-audio|upload-pdf|upload-presentation|upload-images|finalize-pdf|finalize-presentation|finalize-images|warm-preview|daily-quiz|[^/]+\/(summarize|generate-flashcards|regenerate-preview|quiz)|[^/]+\/attachments\/(finalize-image|upload-images))$/;
