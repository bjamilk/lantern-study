import type { DashboardStats, RecentTest, TestAnalysis, TestAnalysisQuestionTime } from '../types/dashboardStats';
...
export function normalizeDashboardStats(stats: DashboardStats): DashboardStats {
  return {
    ...stats,
  ...
  attempt.answers.forEach((answer) => {
    ...
    for (const tag of tags) {
      ...
      if (status !== 'unattempted') {
        stats.totalTime += perQuestionTime;
        stats.count++;
      }
