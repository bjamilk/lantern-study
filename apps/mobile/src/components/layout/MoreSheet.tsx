  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <ThemeScope className="flex-1 justify-end">
        ...
        <View
          style={{ paddingBottom: insets.bottom + 8, backgroundColor: colors.surface }}
          className="rounded-t-3xl border-t border-lantern-border max-h-[70%]"
        >
          ...
          <ScrollView className="px-3">
            {items.map(item => (
              ...
              >
                <Ionicons
                  name={item.icon}
                  size={22}
                  color={item.destructive ? colors.error : iconColor}
                />
                <Text
            ...
            {onToggleLowData ? (
              <Pressable
                ...
                className="flex-row items-center gap-3 px-3 py-3.5 rounded-xl active:bg-lantern-background-secondary dark:active:bg-lantern-surface-secondary"
              >
                <Ionicons name={lowDataMode ? 'cellular-outline' : 'wifi-outline'} size={22} color={iconColor} />
            ...
            <Pressable
              ...
              className="flex-row items-center gap-3 px-3 py-3.5 rounded-xl active:bg-lantern-background-secondary dark:active:bg-lantern-surface-secondary"
            >
              <Ionicons name={theme === 'dark' ? 'sunny-outline' : 'moon-outline'} size={22} color={iconColor} />
              <Text className="flex-1 text-base font-medium text-lantern-text">
