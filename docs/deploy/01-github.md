...
2. For PR-based web previews (test implementations without touching production), see [05-preview-cicd.md](./05-preview-cicd.md).
3. Next step: [02-supabase-cloud.md](./02-supabase-cloud.md) — link CLI, push migrations, configure auth.
