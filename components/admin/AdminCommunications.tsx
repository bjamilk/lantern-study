  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <Card className="space-y-3">
        <h3 className="font-semibold text-lantern-text">Send to one user</h3>
      ...
      <Card className="space-y-3">
        <h3 className="font-semibold text-lantern-text">Bulk send (max 100)</h3>
        <Textarea
          value={userIdsRaw}
          ...
          className="font-mono"
        />
        <p className="text-xs text-lantern-text-muted">Uses the same message, link, and type from the left panel.</p>
