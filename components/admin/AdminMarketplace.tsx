    ...
    <div className="space-y-3">
      <div className="flex flex-wrap gap-2">
        ...
        >
          Orders & disputes
          {disputedCount > 0 ? (
            <span className="ml-1.5 inline-flex items-center justify-center min-w-[1.25rem] h-5 px-1 rounded-full bg-red-500 text-white text-label tracking-normal font-bold">
              {disputedCount}
            </span>
          ) : null}
        </Button>
