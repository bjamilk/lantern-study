              ...
              >
                ...
                <ul className="space-y-2">
                  {(byStatus[col] || []).map((app) => (
                    <li
                      key={app.id}
                      className="rounded-lg border border-lantern-border bg-lantern-surface p-3 space-y-2 shadow-sm"
                    >
                      ...
                      {app.resumePath || app.resumeUrl ? (
                        <button
                          ...
                          onClick={() => void openResume(app.id)}
                          className="text-[11px] font-medium text-lantern-primary underline disabled:opacity-50"
                        >
                          {openingResumeId === app.id
                            ? "Opening…"
