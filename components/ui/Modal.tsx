  ...
  return (
    ...
    >
      <div
        ...
        className={`w-full ${maxWidthClass} transform rounded-lg bg-lantern-surface p-6 shadow-xl transition-all duration-300 dark:bg-lantern-surface ${panelClassName}`}
        style={panelStyle}
      >
        {children}
      </div>
