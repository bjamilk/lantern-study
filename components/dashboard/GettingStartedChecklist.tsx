  ...
  return (
    <div className="rounded-2xl border border-lantern-primary/30 dark:border-lantern-primary/30 bg-lantern-primary-background dark:bg-lantern-primary-background p-4 mb-4">
      <div className="flex items-start justify-between gap-2 mb-3">
        <div>
          <h3 className="text-heading font-bold text-lantern-primary-dark dark:text-lantern-primary-light">Getting started</h3>
          <p className="text-caption text-lantern-primary/80 dark:text-lantern-primary-light/80">
        ...
        {items.map((item) => (
          <li key={item.key}>
            <button
              ...
              className={`w-full flex items-center gap-2 text-left text-body px-2 py-1.5 rounded-lg transition-colors ${
                item.done
