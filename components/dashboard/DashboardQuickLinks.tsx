...
/** Dashboard tiles for AI Tools / Notes / Flashcards / Explore. Screens stay in the sidebar. */
export const SHOW_DASHBOARD_QUICK_LINKS = false;
...
export const DashboardQuickLinks: React.FC<DashboardQuickLinksProps> = ({
  ...
  if (!SHOW_DASHBOARD_QUICK_LINKS) return null;
