...
const ResetPasswordScreen: React.FC<ResetPasswordScreenProps> = ({ onComplete }) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-slate-100 dark:bg-slate-900 transition-colors duration-300">
      <div className="w-full max-w-md m-4 bg-white dark:bg-slate-800/50 dark:border dark:border-slate-700 rounded-3xl shadow-2xl p-8 sm:p-12">
        <div className="text-center mb-8">
          <LanternIcon size={48} className="mx-auto" />
          <h2 className="mt-4 text-3xl font-bold text-slate-900 dark:text-slate-100">Set new password</h2>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-slate-50 dark:bg-slate-700 text-slate-900 dark:text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
